...
#  Sep 02, 2022 09:57:13 PM CEST  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 300x150+344+201
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    wm deiconify $top
    set toptitle "Dice Simulation by Ricky Helfgen"
    ...
    ###################
    place $top.lab46 \
        -in $top -x 0 -relx 0.05 -y 0 -rely 0.067 -width 0 -relwidth 0.433 \
        -height 0 -relheight 0.14 -anchor nw -bordermode ignore 
    place $top.tCo47 \
        -in $top -x 0 -relx 0.693 -y 0 -rely 0.067 -width 0 -relwidth 0.193 \
        -height 0 -relheight 0.14 -anchor nw -bordermode ignore 
    place $top.lab48 \
        -in $top -x 0 -relx 0.05 -y 0 -rely 0.32 -width 0 -relwidth 0.167 \
        -height 0 -relheight 0.207 -anchor nw -bordermode ignore 
    place $top.ent49 \
        -in $top -x 0 -relx 0.61 -y 0 -rely 0.36 -width 86 -relwidth 0 \
        -height 23 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but50 \
        -in $top -x 0 -relx 0.533 -y 0 -rely 0.667 -width 113 -relwidth 0 \
